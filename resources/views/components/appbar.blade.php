    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-default">
        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border  rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 ">
          ...
          <li>
            <a href="#" class="block py-2 px-3 text-white " aria-current="page">Pengaduan</a>
          </li>
          <li>
            <a href="#" class="block py-2 px-3 text-white " aria-current="page">Tentang Kami</a>
          </li>
          <li>
            <a href="#" class="block py-2 px-3 text-white " aria-current="page">Kontak</a>
          </li>
        </ul>
      </div>
    </div>
