<x-layout>
    <div class="text-white  flex flex-col gap-5">
        <div class="w-full flex flex-row items-center justify-between p-6 rounded-lg border border-gray-500 bg-gray-800">
          <p class="font-medium">Tambah Laporan Baru</p>
        </div>
    
        <form action="{{ route('report.submit') }}" method="post" class="max-w-md ml-2 p-4 rounded-md border-gray-300 border bg-gray-50">
            @csrf 
            <!-- NIK -->
